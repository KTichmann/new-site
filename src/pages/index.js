      ...
      <Layout>
        ...
        <div className={styles.project} id={styles.codepad}>
          <div className={styles.projectOverlay}>
            <p>
              For'm - A decoupled forum app with an api run on Node & Postgres,
              and a frontend built in React/Gatsby
            </p>
          </div>
        ...
        <div className={styles.project} id={styles.codepad}>
          <div className={styles.projectOverlay}>
            <p>
              Movie Summarizer - An app that pulls scripts from IMSDB, and
              returns a 3-line summary using TF-IDF.
            </p>
          </div>
